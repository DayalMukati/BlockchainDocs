...
{% embed url="https://github.com/DayalMukati/lxp-recurringpayment-hlf" %}

### It should be cloned inside the hyperledger folder.&#x20;

### Please confirm if fabric-samples and lxp-recurringpayment-hlf folder are available inside the hyperledger folder.&#x20;

### Now copy all the files of the bin folder of fabric-samples to the bin folder of lxp-recurringpayment-hlf.&#x20;
